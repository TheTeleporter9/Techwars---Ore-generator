...
tellraw @p [{"text":"X: ","color":"gray"},{"nbt":"position.x[-1]","storage":"tw:data","color":"blue"},{"text":" | Z: ","color":"gray"},{"nbt":"position.z[-1]","storage":"tw:data","color":"dark_blue"},{"text":" | Position Saved","color":"green"}]